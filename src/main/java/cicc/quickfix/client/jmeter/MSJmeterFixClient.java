...
public class MSJmeterFixClient extends AbstractJavaSamplerClient {
    ...
    public SampleResult runTest(JavaSamplerContext javaSamplerContext) {
        ...
        try{
            ...
            try {
                if("NewOrder".equals(javaSamplerContext.getParameter("ordertype"))){
                    System.out.println(javaSamplerContext.getParameter("ordertype"));
                    application.sendNewOrderRequestByTxt(sessionID,javaSamplerContext.getParameter("fileName"));

                }else if("cancelOrder".equals(javaSamplerContext.getParameter("ordertype"))){
                    System.out.println(javaSamplerContext.getParameter("ordertype"));
